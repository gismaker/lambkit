...
public class LambkitVelocityRender extends LambkitRender {
	...
	public LambkitVelocityRender(String view) {
		super(view);
	}
	...
	public static void setProperties(Properties properties) {
		...
		for (Iterator<Entry<Object, Object>> it=set.iterator(); it.hasNext();) {
			...
			LambkitVelocityRender.properties.put(e.getKey(), e.getValue());
		}
	}
