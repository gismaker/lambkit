 ...
 * @since 1.0
 */
public class UpmsSystemValidator extends LambkitValidator {

	@Override
	protected String getTableName(Controller c) {
		return UpmsSystem.service().getTableName();
	}
	
	@Override
	protected String getPrefix() {
		return "model";//StrKit.firstCharToLowerCase(UpmsSystem.class.getSimpleName());
	}
}
