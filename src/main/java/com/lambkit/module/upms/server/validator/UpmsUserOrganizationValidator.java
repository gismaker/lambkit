 ...
 * @since 1.0
 */
public class UpmsUserOrganizationValidator extends LambkitValidator {

	@Override
	protected String getTableName(Controller c) {
		return UpmsUserOrganization.service().getTableName();
	}
	
	@Override
	protected String getPrefix() {
		return "model";//StrKit.firstCharToLowerCase(UpmsUserOrganization.class.getSimpleName());
	}
}
