 ...
 */
/**
 * upms_organization标签<br>
 * 参数：{id:主键}
 * 返回值：{entity:upms_organization信息}
 * @author lambkit
 */
public class UpmsOrganizationDirective extends LambkitTemplateModel {
	...
	public void onRender(Environment env, Map params, TemplateModel[] loopVars,
		...
		String sql = " from upms_organization where "; 
		if(wheresql == null) {
			sql += " 1=1 ";
		...
		UpmsOrganizationService service = UpmsOrganization.service();
