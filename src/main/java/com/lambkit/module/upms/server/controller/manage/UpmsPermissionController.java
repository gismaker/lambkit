...
public class UpmsPermissionController extends BaseController {
    ...
    private UpmsPermissionService upmsPermissionService = Enhancer.enhance(UpmsPermissionServiceImpl.class);

    private UpmsSystemService upmsSystemService = Enhancer.enhance(UpmsSystemServiceImpl.class);
