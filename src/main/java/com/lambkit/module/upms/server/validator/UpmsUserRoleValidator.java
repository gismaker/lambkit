 ...
 * @since 1.0
 */
public class UpmsUserRoleValidator extends LambkitValidator {

	@Override
	protected String getTableName(Controller c) {
		return UpmsUserRole.service().getTableName();
	}
	
	@Override
	protected String getPrefix() {
		return "model";//StrKit.firstCharToLowerCase(UpmsUserRole.class.getSimpleName());
	}
}
