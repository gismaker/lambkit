 ...
 * @since 1.0
 */
public class UpmsUserPermissionValidator extends LambkitValidator {

	@Override
	protected String getTableName(Controller c) {
		return UpmsUserPermission.service().getTableName();
	}
	
	@Override
	protected String getPrefix() {
		return "model";//StrKit.firstCharToLowerCase(UpmsUserPermission.class.getSimpleName());
	}
}
