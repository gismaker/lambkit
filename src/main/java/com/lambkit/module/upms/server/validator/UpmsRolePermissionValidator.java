 ...
 * @since 1.0
 */
public class UpmsRolePermissionValidator extends LambkitValidator {

	@Override
	protected String getTableName(Controller c) {
		return UpmsRolePermission.service().getTableName();
	}
	
	@Override
	protected String getPrefix() {
		return "model";//StrKit.firstCharToLowerCase(UpmsRolePermission.class.getSimpleName());
	}
}
