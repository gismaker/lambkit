 ...
 * @since 1.0
 */
public class UpmsFavoritesValidator extends LambkitValidator {

	@Override
	protected String getTableName(Controller c) {
		return UpmsFavorites.service().getTableName();
	}
	
	@Override
	protected String getPrefix() {
		return "model";//StrKit.firstCharToLowerCase(UpmsFavorites.class.getSimpleName());
	}
}
