...
public abstract class BaseUpmsUserOrganization<M extends BaseUpmsUserOrganization<M>> extends BaseModel<M> implements IBean {
	...
	public java.lang.Long getUserOrganizationId() {
		return this.get("user_organization_id");
	}

	public void setUserOrganizationId(java.lang.Long userOrganizationId) {
		this.set("user_organization_id", userOrganizationId);
	}
