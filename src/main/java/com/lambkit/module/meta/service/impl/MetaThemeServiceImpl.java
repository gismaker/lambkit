...
public class MetaThemeServiceImpl extends BaseModelServiceImpl<MetaTheme> implements MetaThemeService {
	...
	public MetaTheme dao() {
		if(DAO==null) {
			DAO = Enhancer.enhance(MetaTheme.class.getName(), MetaTheme.class);
		}
		return DAO;
	}

	@Override
	public MetaTheme activedTheme() {
		// TODO Auto-generated method stub
		Column column = Column.create("active", 1);
		return dao().findFirstByColumn(column);
	}

	@Override
	public Long activedThemeId() {
		// TODO Auto-generated method stub
		Column column = Column.create("active", 1);
		MetaTheme m = dao().findFirstByColumn(column);
		if(m==null) {
			return 0L;
		}
		return m.getId();
