 ...
 * @since 1.0
 */
public class MetaFieldMapServiceMock extends BaseServiceMock<MetaFieldMap> implements MetaFieldMapService {

	@Override
	public MetaFieldMap findFistByFieldId(Long fldid) {
