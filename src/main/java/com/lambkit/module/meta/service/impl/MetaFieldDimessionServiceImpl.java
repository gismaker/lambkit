 ...
 * @since 1.0
 */
public class MetaFieldDimessionServiceImpl extends LambkitModelServiceImpl<MetaFieldDimession> implements MetaFieldDimessionService {
	
	private MetaFieldDimession DAO = null;
	
	public MetaFieldDimession dao() {
		if(DAO==null) {
			DAO = AopKit.singleton(MetaFieldDimession.class);
		}
		return DAO;
	}

	@Override
	public MetaFieldDimession findFistByFieldId(Long fldid) {
