 ...
 * @since 1.0
 */
public class MetaFieldEditServiceMock extends BaseServiceMock<MetaFieldEdit> implements MetaFieldEditService {

	@Override
	public MetaFieldEdit findByFieldAndTheme(Long fldid, Long tmid) {
