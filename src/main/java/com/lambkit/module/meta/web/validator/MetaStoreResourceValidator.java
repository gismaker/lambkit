 ...
 * @since 1.0
 */
public class MetaStoreResourceValidator extends LambkitValidator {

	@Override
	protected String getTableName(Controller c) {
		return MetaStoreResource.service().getTableName();
	}
	
	@Override
	protected String getPrefix() {
		return "model";//StrKit.firstCharToLowerCase(MetaStoreResource.class.getSimpleName());
	}
}
