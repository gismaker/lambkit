 ...
 * @since 1.0
 */
public class MetaFieldDimessionValidator extends LambkitValidator {

	@Override
	protected String getTableName(Controller c) {
		return MetaFieldDimession.service().getTableName();
	}
	
	@Override
	protected String getPrefix() {
		return "model";//StrKit.firstCharToLowerCase(MetaFieldDimession.class.getSimpleName());
	}
}
