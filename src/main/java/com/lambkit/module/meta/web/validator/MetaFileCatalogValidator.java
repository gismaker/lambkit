 ...
 * @since 1.0
 */
public class MetaFileCatalogValidator extends LambkitValidator {

	@Override
	protected String getTableName(Controller c) {
		return MetaFileCatalog.service().getTableName();
	}
	
	@Override
	protected String getPrefix() {
		return "model";//StrKit.firstCharToLowerCase(MetaFileCatalog.class.getSimpleName());
	}
}
