 ...
 * @since 1.0
 */
public class MetaFieldRelationValidator extends LambkitValidator {

	@Override
	protected String getTableName(Controller c) {
		return MetaFieldRelation.service().getTableName();
	}
	
	@Override
	protected String getPrefix() {
		return "model";//StrKit.firstCharToLowerCase(MetaFieldRelation.class.getSimpleName());
	}
}
