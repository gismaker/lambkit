 ...
 * @since 1.0
 */
public class MetaFieldEditValidator extends LambkitValidator {

	@Override
	protected String getTableName(Controller c) {
		return MetaFieldEdit.service().getTableName();
	}
	
	@Override
	protected String getPrefix() {
		return "model";//StrKit.firstCharToLowerCase(MetaFieldEdit.class.getSimpleName());
	}
}
