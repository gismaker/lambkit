 ...
 * @since 1.0
 */
public class MetaFieldMeasureValidator extends LambkitValidator {

	@Override
	protected String getTableName(Controller c) {
		return MetaFieldMeasure.service().getTableName();
	}
	
	@Override
	protected String getPrefix() {
		return "model";//StrKit.firstCharToLowerCase(MetaFieldMeasure.class.getSimpleName());
	}
}
