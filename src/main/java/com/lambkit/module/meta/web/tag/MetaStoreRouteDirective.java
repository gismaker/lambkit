 ...
 */
/**
 * meta_store_route标签<br>
 * 参数：{id:主键}
 * 返回值：{entity:meta_store_route信息}
 * @author lambkit
 */
public class MetaStoreRouteDirective extends LambkitTemplateModel {
	...
	public void onRender(Environment env, Map params, TemplateModel[] loopVars,
		...
		String sql = " from meta_store_route where "; 
		if(wheresql == null) {
			sql += " 1=1 ";
		...
		MetaStoreRouteService service = MetaStoreRoute.service();
