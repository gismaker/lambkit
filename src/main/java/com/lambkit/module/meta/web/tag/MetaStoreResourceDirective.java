 ...
 */
/**
 * meta_store_resource标签<br>
 * 参数：{id:主键}
 * 返回值：{entity:meta_store_resource信息}
 * @author lambkit
 */
public class MetaStoreResourceDirective extends LambkitTemplateModel {
	...
	public void onRender(Environment env, Map params, TemplateModel[] loopVars,
		...
		String summary = get(params, "summary");
		...
		String sql = " from meta_store_resource where "; 
		if(wheresql == null) {
			sql += " 1=1 ";
			...
			if(StringUtils.hasText(summary)) sql += " and summary like '%" + summary + "%'";//varchar
		...
		MetaStoreResourceService service = MetaStoreResource.service();
