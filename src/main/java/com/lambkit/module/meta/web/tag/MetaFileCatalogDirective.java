 ...
 */
/**
 * meta_file_catalog标签<br>
 * 参数：{id:主键}
 * 返回值：{entity:meta_file_catalog信息}
 * @author lambkit
 */
public class MetaFileCatalogDirective extends LambkitTemplateModel {
	...
	public void onRender(Environment env, Map params, TemplateModel[] loopVars,
		...
		String sql = " from meta_file_catalog where "; 
		if(wheresql == null) {
			sql += " 1=1 ";
