 ...
 * @since 1.0
 */
public class MetaStoreDbValidator extends LambkitValidator {

	@Override
	protected String getTableName(Controller c) {
		return MetaStoreDb.service().getTableName();
	}
	
	@Override
	protected String getPrefix() {
		return "model";//StrKit.firstCharToLowerCase(MetaStoreDb.class.getSimpleName());
	}
}
