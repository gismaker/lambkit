...
import com.lambkit.module.meta.model.base.BaseMetaApi;
import com.lambkit.module.meta.model.sql.MetaApiCriteria;
 ...
 * @since 1.0
 */
public class MetaApi extends BaseMetaApi<MetaApi> {

	private static final long serialVersionUID = 1L;
	
	public static MetaApiService service() {
		return ServiceKit.inject(MetaApiService.class, MetaApiServiceImpl.class);
	}
	
	public static MetaApiCriteria sql() {
		return new MetaApiCriteria();
	}
	
	public static MetaApiCriteria sql(Column column) {
