...
import com.lambkit.module.meta.model.base.BaseMetaImageSet;
 ...
 * @since 1.0
 */
public class MetaImageSet extends BaseMetaImageSet<MetaImageSet> {

	private static final long serialVersionUID = 1L;
	
	public static MetaImageSetService service() {
		return ServiceKit.inject(MetaImageSetService.class, MetaImageSetServiceImpl.class);
	}
	
	public static MetaImageSetCriteria sql() {
		return new MetaImageSetCriteria();
	}
	
	public static MetaImageSetCriteria sql(Column column) {
