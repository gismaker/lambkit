...
import com.lambkit.module.meta.model.base.BaseMetaApp;
import com.lambkit.module.meta.model.sql.MetaAppCriteria;
 ...
 * @since 1.0
 */
public class MetaApp extends BaseMetaApp<MetaApp> {

	private static final long serialVersionUID = 1L;
	
	public static MetaAppService service() {
		return ServiceKit.inject(MetaAppService.class, MetaAppServiceImpl.class);
	}
	
	public static MetaAppCriteria sql() {
		return new MetaAppCriteria();
	}
	
	public static MetaAppCriteria sql(Column column) {
