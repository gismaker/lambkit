...
import com.lambkit.module.meta.model.base.BaseMetaFileCatalog;
 ...
 * @since 1.0
 */
public class MetaFileCatalog extends BaseMetaFileCatalog<MetaFileCatalog> {

	private static final long serialVersionUID = 1L;
	
	public static MetaFileCatalogService service() {
		return ServiceKit.inject(MetaFileCatalogService.class, MetaFileCatalogServiceImpl.class);
	}
	
	public static MetaFileCatalogCriteria sql() {
		return new MetaFileCatalogCriteria();
	}
	
	public static MetaFileCatalogCriteria sql(Column column) {
		MetaFileCatalogCriteria that = new MetaFileCatalogCriteria();
		that.add(column);
        return that;
    }

	public MetaFileCatalog() {
