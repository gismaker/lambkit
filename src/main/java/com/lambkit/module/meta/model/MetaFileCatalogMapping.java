...
import com.lambkit.module.meta.model.base.BaseMetaFileCatalogMapping;
 ...
 * @since 1.0
 */
public class MetaFileCatalogMapping extends BaseMetaFileCatalogMapping<MetaFileCatalogMapping> {

	private static final long serialVersionUID = 1L;
	
	public static MetaFileCatalogMappingService service() {
		return ServiceKit.inject(MetaFileCatalogMappingService.class, MetaFileCatalogMappingServiceImpl.class);
	}
	
	public static MetaFileCatalogMappingCriteria sql() {
		return new MetaFileCatalogMappingCriteria();
	}
	
	public static MetaFileCatalogMappingCriteria sql(Column column) {
		MetaFileCatalogMappingCriteria that = new MetaFileCatalogMappingCriteria();
		that.add(column);
        return that;
    }

	public MetaFileCatalogMapping() {
