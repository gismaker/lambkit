...
public class GatewayRender extends Render {
	...
	protected static final String ATTR_TARGET_URI = GatewayRender.class.getSimpleName() + ".targetUri";
	protected static final String ATTR_TARGET_HOST = GatewayRender.class.getSimpleName() + ".targetHost";
