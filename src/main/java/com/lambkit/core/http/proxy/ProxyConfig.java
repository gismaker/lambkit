...
//@PropertieConfig(prefix = "lambkit.http.proxy")
public class ProxyConfig {
	...
	private List<ProxyConfig> childProxyConfigs;
	...
	public List<ProxyConfig> getChildProxyConfigs() {
		return childProxyConfigs;
	}

	public void setChildProxyConfigs(List<ProxyConfig> childProxyConfigs) {
