...
public class ProxyHandler extends Handler {
	static Log log = Log.getLog(ProxyHandler.class);

	/** The parameter name for the target (destination) URI to proxy to. */
	protected static final String P_TARGET_URI = "targetUri";
	protected static final String ATTR_TARGET_URI = ProxyHandler.class.getSimpleName() + ".targetUri";
	protected static final String ATTR_TARGET_HOST = ProxyHandler.class.getSimpleName() + ".targetHost";
	...
	public void init(ProxyConfig config) throws LambkitException {
