...
public class LambkitSqlServerDialect extends SqlServerDialect implements IModelDialect, IManagerDialect {
	...
	public String getCreateTableSQL(String tbname, List<? extends IField> tflv) {
		...
		// System.out.println("CREATE TABLE IF NOT EXISTS " + tbname + " ( " +
		// field + ")");
	...
	public String getAlterAddSQL(String tbname, String fldinfo, String after) {
		...
		// System.out.println("alter table " + tbname + " add column " + fldinfo
		// + after + ";");
	...
	public String getAlterChangeSQL(String tbname, String fldinfo, String after) {
		// TODO Auto-generated method stub
		after = after != null && after.length() > 0 && !after.isEmpty() ? " after " + after : "";
		// System.out.println("alter table " + tbname + " change " + fldinfo +
		// after + ";");
	...
	public String getAlterModifySQL(String tbname, String fldinfo, String after) {
		// TODO Auto-generated method stub
		after = after != null && after.length() > 0 && !after.isEmpty() ? " after " + after : "";
		// System.out.println("alter table " + tbname + " modify " + fldinfo +
		// after + ";");
	...
	public String getTableSQL(String dbname, String tbname) {
		// TODO Auto-generated method stub
		return "SELECT table_name FROM information_schema.TABLES WHERE table_schema='" + dbname + "' and table_name='"
				+ tbname + "'";
	}
	...
	public String getSelectTopOne(String tbname) {
		// TODO Auto-generated method stub
		return "select top 1 * from " + tbname;
	}
