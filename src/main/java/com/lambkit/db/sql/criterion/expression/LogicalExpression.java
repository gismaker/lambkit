...
public class LogicalExpression implements Criterion, Serializable {

	private static final long serialVersionUID = 1L;
	private Criterion lhs, rhs;
	private String op;
	...
	public SqlParas getSqlParas(Criteria criteria) {
		...
		SqlParas csql = lhs.getSqlParas(criteria);
		if(op.equalsIgnoreCase("and")) {
			csql.and(criteria, rhs);
		} else if(op.equalsIgnoreCase("or")) {
			csql.or(criteria, rhs);
		}
