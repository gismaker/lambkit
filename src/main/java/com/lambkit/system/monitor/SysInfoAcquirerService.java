 ...
 */
package com.lambkit.system.monitor;
...
public class SysInfoAcquirerService {
	static Log log = Log.getLog(SysInfoAcquirerService.class);
	...
	private LimitQueue<SysPerformInfo> sysInfoQueue;
	 ...
	 */
	public void init() {
		sysInfoQueue = new LimitQueue<>(100);
	...
	private long[] readCpu(final Process proc) {  
        ...
        try {  
            ...
            while ((line = input.readLine()) != null) {  
                ...
                String caption = this.substring(line, capidx, cmdidx - 1)  
                        .trim();  
                ...
                if (caption.equals("System Idle Process")  
                    ...
                    idletime += Long.valueOf(  
                    		this.substring(line, kmtidx, rocidx - 1).trim())  
                            .longValue();  
                    idletime += Long.valueOf(  
                    		this.substring(line, umtidx, wocidx - 1).trim())  
                            .longValue();  
                    continue;  
                }  
		...
		public void run() {
			try {
				...
				*/
				...
				getSysInfoQueue().offer(sysPerformInfo);
				//
	...
	public LimitQueue<SysPerformInfo> getSysInfoQueue() {
		return sysInfoQueue;
	}

	public void setSysInfoQueue(LimitQueue<SysPerformInfo> sysInfoQueue) {
		this.sysInfoQueue = sysInfoQueue;
	}
}
